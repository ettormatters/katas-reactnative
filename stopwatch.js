/**
 * https://github.com/fangwei716/30-days-of-react-native/blob/development/view/day1.js
 * Day 1
 * A stop watch
 */
'use strict'
...
export default class extends Component {
  ...
  _startWatch() {
    ...
    let interval = setInterval(
      () => {
        ...
        milSecond = Math.floor((countingTime%10000/10));
  ...
  _addRecord() {
    ...
    record.unshift({title:"count"+recordCounter,time:this.state.sectionTime});
    this.setState({
