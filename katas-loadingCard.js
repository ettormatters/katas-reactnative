...
import Icon from 'react-native-vector-icons/Ionocons'
import colors from '@/runner/colors'

const LoadingCard = (props) => {
  return (
    <View style={StyleSheet.container}>
      <View style={{flexDirection:'row', width:200, height:80, backgroundColor:'#CDD39',padding:10,paddingTop:5}}>
